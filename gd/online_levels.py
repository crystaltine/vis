...
def _draw_search_level_button(outline:bool): 
    draw(f"gd/assets/level_editor_menu/search_button{'_outline' if outline else ''}.png", pos=Position.Relative(left="calc(30% - 13ch)", bottom="calc(50% - 13ch)"))
...
def _draw_uploaded_levels_button(outline:bool): 
    draw(f"gd/assets/level_editor_menu/publish_button_main{'_outline' if outline else ''}.png", pos=Position.Relative(right="calc(50% - 46ch)", bottom="calc(50% - 13ch)"))
...
def init_online_levels_page(terminal): 
    ...
    draw_menu_background('gd/assets/level_editor_menu/level_editor_menu.png', terminal)
