...
class CreatedLevelsMenu:
    ...
    def render():
        ...
        new_frame.fill((CreatedLevelsMenu.BG_COLOR))

        horiz_center = int(0.5 * new_frame.width)
        title_center = int(CreatedLevelsMenu.TITLE_MARGIN_TOP * new_frame.height + TextureManager.font_title.font_height/2)
        
        # draw title text
        new_frame.add_text(horiz_center, title_center, TextureManager.font_title, "Created Levels", color=CreatedLevelsMenu.TITLE_COLOR)
        
        # TODO
        new_frame.add_text(horiz_center, title_center + TextureManager.font_title.font_height + 2, TextureManager.font_title, "Coming Soon!", color=CreatedLevelsMenu.TITLE_COLOR)
        ...
        if CreatedLevelsMenu.curr_frame is not None:
            new_frame.render(CreatedLevelsMenu.curr_frame)
        else: 
